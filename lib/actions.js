        ...
        this.client.interceptors.response.use(
            ...
            error => {
                if (error.code === 'ECONNREFUSED') {
                    console.error(`\x1b[31m[Autopilot Error] Could not connect to the app at ${error.config.baseURL}.\x1b[0m`);
                    console.error(`\x1b[33mEnsure the app is running with Autopilot and you have run: adb forward tcp:8080 tcp:8080\x1b[0m`);
                }
